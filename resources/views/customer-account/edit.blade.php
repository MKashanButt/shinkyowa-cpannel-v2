                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <x-select-box id="currency_id" name="currency_id" class="w-4/5">
                            ...
                            @foreach ($currencies as $key => $item)
                                <option value="{{ $key }}"
                                    {{ old('currency_id', $customerAccount->currency_id) == $key ? 'selected' : '' }}>
                                    {{ $item }}
                                </option>
                            @endforeach
                        </x-select-box>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <x-select-box id="country_id" name="country_id" class="w-4/5">
                            ...
                            @foreach ($countries as $key => $item)
                                <option value="{{ $key }}"
                                    {{ old('country_id', $customerAccount->country_id) == $key ? 'selected' : '' }}>
                                    {{ $item }}
                                </option>
                            @endforeach
                        </x-select-box>
                    ...
                    <div class="flex items-center gap-2 w-[32.5%]">
                        ...
                        <x-select-box id="agent_id" name="agent_id" class="w-4/5">
                            ...
                            @foreach ($agents as $key => $item)
                                <option value="{{ $key }}"
                                    {{ old('agent_id', $customerAccount->agent_id) == $key ? 'selected' : '' }}>
                                    {{ $item }}
                                </option>
                            @endforeach
                        </x-select-box>
