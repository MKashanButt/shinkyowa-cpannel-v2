<x-app-layout>
    <section>
        <x-breadcrumbs :page="'Vehicles'" :subpage="'Shipment'" :category="'Edit'" />
        <x-header>
            {{ __('Edit Shipment') }}
        ...
        <form action="{{ route('shipment.update', $shipment->id) }}" method="POST"
            ...
            <div>
                ...
                <div class="w-full grid grid-cols-3 gap-4">
                    <div class="flex items-center gap-2">
                        <x-input-label for="vessel_name" class="w-[32%] after:content-['*'] after:text-red-500">
                            Vessel Name
                        </x-input-label>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="relative max-w-sm w-4/5">
                            ...
                            <input datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text"
                                ...
                                placeholder="Select date" value="{{ old('etd', $shipment->etd) }}">
                        </div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="relative max-w-sm w-4/5">
                            ...
                            <input datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text"
                                id="eta" name="eta"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5"
                                placeholder="Select date" value="{{ old('eta', $shipment->eta) }}">
                        </div>
            ...
            <div>
                <h2 class="w-full bg-gray-200/50 my-2 p-2 border-l-2 border-blue-900">Stocks</h2>
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                const etaPicker = new Datepicker(document.getElementById('eta'), {
                    format: 'yyyy-mm-dd',
                    autohide: true
                });

                const etdPicker = new Datepicker(document.getElementById('etd'), {
                    format: 'yyyy-mm-dd',
                    autohide: true
                });
            });
